...
TMPDIR = $(TEMP_BUILD)\$(WORKSPACE)\$(PROJECT)_120_$(CPU)$(DBGSFX)$(LINKSFX)
OBJDIR = $(TMPDIR)\obj
...
CCFLAGS = $(_CCFLAGS) $(_ECCFLAGS) -DPOSIXBUILDTIME=$(BUILDTIME) -D_RANDOM=$(BUILDRANDOM) $(EXTCFLAGS)
CCXFLAGS = $(_CCXFLAGS) $(_ECCFLAGS) -DPOSIXBUILDTIME=$(BUILDTIME) -D_RANDOM=$(BUILDRANDOM) $(EXTCFLAGS)
